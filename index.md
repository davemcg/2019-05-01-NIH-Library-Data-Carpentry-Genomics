...
venue: "NIH Library Training Room"        # brief name of host site without address (e.g., "Euphoric State University")
address: "NIH Library, 10 Center Drive, Building 10, Bethesda, MD 20892"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "US"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "EN"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "39.000789,-77.104737"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "May 1-2, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["David McGaughey","Martin Skarzynski", "Doug Joubert", "Abhijit Dasgupta"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper:    ["Bin Guan"] # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["mcgaugheyd@mail.nih.gov", "Martin.Skarzynski@nih.gov", "joubertd@ors.od.nih.gov"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2019-05-01-NIH-Library-DC          # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
